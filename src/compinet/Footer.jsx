  ...
  return (
    <footer className="bg-black text-gray-300 py-10 text-sm">
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-4 gap-8">
        ...
        {/* Brand Info */}
        <div>
          <Link to="/" className="text-indigo-600 text-2xl font-bold">DPoster</Link>
        ...
        <div>
          ...
          <form className="mt-4 flex">
            ...
            />
            <button className="bg-indigo-600 px-4 rounded-r text-white hover:bg-red-700">
              Subscribe
            </button>
          </form>
        </div>
      ...
      <div className="mt-8 text-center border-t border-gray-700 pt-4">
        <p>&copy; {new Date().getFullYear()} <span className="text-indigo-600">Jalvix</span>. All rights reserved.</p>
      </div>
    </footer>
  )
}

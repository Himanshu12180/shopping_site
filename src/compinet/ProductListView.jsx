...
function ProductListView({ product }) {
    ...
    return (
        <div className='space-y-4 mt-2 rounded-md'>
            <div className='bg-gray-300 flex gap-7 items-center p-2 rounded-md'>
                <img
                    src={product.image}
                    alt={product.title}
                ...
                <div className='space-y-2'>
                    ...
                    <button
                        ...
                        className='bg-gradient-to-r from-purple-500 to-indigo-400 ring-sky-300 text-white px-3 py-1 rounded-md'>
                        Add to Cart
                    </button>
                </div>
            </div>
